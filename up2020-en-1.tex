...
\item \stress{Simplicity}: the hardware limitations on machines accessible
	at Bell Labs around 1970 resulted in the pursuit for economy and elegance
...
tools are implemented, each of them usually needs to be partitioned into
...
pursuits simplicity, is extremely important to software security.
...
regarding FOSS.  First, the pursuit for simplicity can \stress{save time and
...
In the end of last section, I mentioned that the pursuit for simplicity can
