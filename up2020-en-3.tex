...
pioneers in time-sharing operating systems (\cf~Section~\ref{sec:intro}).},
who showed that a practically usable Turing-complete language can be built
with a handful of primitive
...
programmers at that time generally preferred to
use S-expression directly.  M-expressions are
